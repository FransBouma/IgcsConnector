...
namespace reshade::api
{
	...
	RESHADE_DEFINE_INTERFACE_WITH_BASE(effect_runtime, swapchain)
	{
		...
		///	<remarks>By default the flag is set to true, only set this flag to <see langword="false"/> if you set uniform variables in a loop, or multiple times in a handler to the reshade_present event</remarks>
